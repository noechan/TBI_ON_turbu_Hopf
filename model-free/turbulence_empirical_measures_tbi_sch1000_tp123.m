...
load('tseries_openneuro_tbi_tp123_sch1000.mat')               % Denoised time-series
...
% Set Parameters
cond=1;                                     % Number of sessions (MANUAL INPUT!!!)
...
save (sprintf('turbu_all_measurements_openneuro_tbi_con%d.mat',cond), 'LAMBDA','TurbulenceRSN_sub','Turbulence_global_sub', 'Transfer_sub', 'InformationCascade_sub', 'TransferLambda_sub','gKoPRSN','MetaRSN','gKoP','Meta');
